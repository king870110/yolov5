    ...
    def forward(self, ims, size=640, augment=False, profile=False):
        ...
        with dt[0]:
            ...
            if isinstance(ims, torch.Tensor):  # torch
                # with amp.autocast(autocast): # old method
                with torch.amp.autocast(device_type="cuda", enabled=autocast):  # gpu
                    # with torch.amp.autocast(device_type='cpu', enabled=autocast): #cpu
                    return self.model(
